            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                {((isSaturday(formData.date) || isFriday(formData.date) || formData.date > '2026-06-04') ? [...lunchTimeSlots, ...timeSlots] : timeSlots).filter(time => {
                  ...
                  if (formData.date === '2026-07-11' && (time === '6:00 PM' || time === '6:15 PM' || time === '6:30 PM' || time === '6:45 PM' || time === '7:00 PM' || time === '7:15 PM' || time === '7:30 PM' || time === '7:45 PM')) return false
                  if (formData.date === '2026-07-16' && (time === '6:00 PM' || time === '6:15 PM' || time === '6:30 PM' || time === '6:45 PM')) return false
                  if (formData.date === '2026-07-17' && (time === '6:00 PM' || time === '6:15 PM' || time === '6:30 PM' || time === '6:45 PM' || time === '7:00 PM')) return false
                  if (formData.date === '2026-07-18' && (time === '5:00 PM' || time === '5:30 PM' || time === '5:45 PM')) return false
                  if (formData.date === '2026-07-19' && (time === '6:00 PM' || time === '6:15 PM' || time === '6:30 PM' || time === '6:45 PM' || time === '7:00 PM')) return false
